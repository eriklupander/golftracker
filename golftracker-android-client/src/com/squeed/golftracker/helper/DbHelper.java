...
//	public List<Club> getClubs(SQLiteDatabase db) {
//		Cursor q = db.rawQuery("SELECT id, external_id, name, long_name, " + KEY_EST_LEN + ", icon_id, owner_id from " + CLUB_TABLE_NAME + ";", null);
//		q.moveToFirst();
//		List<Club> clubs = new ArrayList<Club>();
//		while(!q.isAfterLast()) {
//			clubs.add(new Club(q.getLong(0), q.getLong(1), q.getString(2), q.getString(3), q.getInt(4), q.getInt(5)));
//			q.moveToNext();
//		}
//		return clubs;
//	}
//	
//	
//	public List<ShotProfile> getShotProfiles(SQLiteDatabase db) {
//		Cursor q = db.rawQuery("SELECT id, external_id, name, icon_id from " + SHOT_PROFILE_TABLE_NAME + ";", null);
//		q.moveToFirst();
//		List<ShotProfile> shotProfiles = new ArrayList<ShotProfile>();
//		while(!q.isAfterLast()) {
//			shotProfiles.add(new ShotProfile(q.getLong(0), q.getLong(1), q.getString(2), q.getInt(3)));
//			q.moveToNext();
//		}
//		return shotProfiles;
//	}
...
//	
//	
//	public Course loadCourseFromDb(SQLiteDatabase db, Long courseId) {
//		Course c = new Course();
//		
//		// Get course name
...
//	}
//
//	private void addHoles(SQLiteDatabase db, Long courseId, Course c) {
...
//	}
//
//	private void addPois(SQLiteDatabase db, Course c) {
...
//				PointOfInterest poi = new PointOfInterest(poiQuery.getLong(0), poiQuery.getString(1), poiQuery.getString(2), poiQuery.getDouble(3), poiQuery.getDouble(4));
...
//	}
//
//	private void addTees(SQLiteDatabase db, Long courseId, Course c) {
...
//	}
//	
//	public Hole loadHole(SQLiteDatabase db, Long id) {
...
//	}
//
//	public List<Course> loadCourses(SQLiteDatabase db, String term) {
...
//	}
//
//	public void updateHole(SQLiteDatabase db, Hole currentHole) {
...
//	}
//
//	public void deletePoi(SQLiteDatabase db, PointOfInterest poi, Long ownerId) {
...
//	 * @param dto
//	 */
//	public void deleteCourse(SQLiteDatabase db, Course dto) {
//		
//		for(Hole h : dto.getHoles()) {
