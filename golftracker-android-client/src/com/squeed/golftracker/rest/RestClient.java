...
public class RestClient {
	...
	private static String _LOCALHOST = "10.0.2.2";
...
//		httpPost.setEntity(se);
	...
	public User getUser(Long userId) {
		try {
			InputStream is = get(_LOCALHOST, 8080, "/golftracker-server/rest/user/" + userId);
...
//	}
	...
	public List<GolfVenue> getGolfVenues(Double lon, Double lat) {
		try {
			InputStream is = get(_LOCALHOST, 8080, "/golftracker-server/rest/course/nearby?lon=123&lat=345"); // golftracker-server/rest/course/nearby
	...
	public Course getCourse(long courseId) {
		try {
			InputStream is = get(_LOCALHOST, 8080, "/golftracker-server/rest/course/" + courseId);
	...
	public List<Course> getCoursesOfVenue(Long venueId) {
		try {
			InputStream is = get(_LOCALHOST, 8080, "/golftracker-server/rest/course/venue/" + venueId + "/courses");
